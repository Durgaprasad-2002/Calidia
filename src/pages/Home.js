...
// const FeaturesCard = lazy(() => import("./Components/Features_card"));
// const Card2 = lazy(() => import("./Components/ProductsInfoHome"));
...
//       // Optimize scroll effect for images
...
//     }, 0); // Use throttle to limit updates
...
//     <>
//       {/* Language Selector */}
//       <div className="Locale-changer" style={{ display: display }}>
//         <select
//           value={locale}
...
//           <div ref={scrollRef} style={scrollStyles}>
